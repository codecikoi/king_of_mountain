...
import 'package:king_of_mountain/ui/widgets/exit_button.dart';
...
class FirstVsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return
        ...
        // BlocProvider(
        // create: (context) => AvengerBloc(), /// допилить
        Scaffold(
      body: SafeArea(
        child: Column(
          ...
          children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      AvengerInfo(
                        ...
                        onTap: () {
                          context.read<AvengerBloc>().add(SelectedAvengerEvent(
            ...
            ExitButton(
              onTap: () {},
              buttonText: 'finish',
              color: AvengersColors.exitButtonColor,
            ),
          ],
        ),
      ),
